...
cookie_file='D:/A_TEMP/UPC-nCoV-submit/Github_Action/cookie.txt' #保存cookie文件
user_file="D:/A_TEMP/UPC-nCoV-submit/自动填表/用户信息.txt"   #用户信息文件
log_file="D:/A_TEMP/UPC-nCoV-submit/Github_Action/result.txt" #日志文件
